CREATE TABLE [dbo].[currency_rates_bck_20170918] (
...
CREATE NONCLUSTERED INDEX [IX_currency_rates_from]
    ON [dbo].[currency_rates_bck_20170918]([from_currency_id] ASC, [to_currency_id] ASC, [date] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_currency_rates_to]
    ON [dbo].[currency_rates_bck_20170918]([to_currency_id] ASC, [from_currency_id] ASC, [date] ASC);

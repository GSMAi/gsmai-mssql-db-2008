CREATE TABLE [dbo].[currency_rates_copy] (
...
CREATE NONCLUSTERED INDEX [IX_currency_rates_from]
    ON [dbo].[currency_rates_copy]([from_currency_id] ASC, [to_currency_id] ASC, [date] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_currency_rates_to]
    ON [dbo].[currency_rates_copy]([to_currency_id] ASC, [from_currency_id] ASC, [date] ASC);

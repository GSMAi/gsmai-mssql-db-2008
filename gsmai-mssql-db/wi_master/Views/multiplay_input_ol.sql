CREATE VIEW dbo.multiplay_input_ol
...
WHERE        (o.fk_metric_id IN (350, 351, 352, 353, 354, 355, 356, 357, 358, 359, 360, 362, 363, 364, 366, 365, 378)) AND (o.date_type = 'Q') AND (ol.fk_data_view_id = 1) AND (o.archive = 0) AND (os.type_id = 1594))
GO
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         ...
         Begin Table = "a"
            ...
            DisplayFlags = 280
            TopColumn = 0
         End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'multiplay_input_ol';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'multiplay_input_ol';

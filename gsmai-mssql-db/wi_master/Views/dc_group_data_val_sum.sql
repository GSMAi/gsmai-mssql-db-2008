CREATE VIEW [dbo].[dc_group_data_val_sum] WITH SCHEMABINDING AS select 
	od.id as "id", 
...
GO
CREATE UNIQUE CLUSTERED INDEX [dc_group_data_val_sum_unique]
    ON [dbo].[dc_group_data_val_sum]([id] ASC);

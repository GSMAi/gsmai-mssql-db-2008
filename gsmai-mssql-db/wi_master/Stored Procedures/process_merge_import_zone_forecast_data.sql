...
CREATE PROCEDURE [dbo].[process_merge_import_zone_forecast_data]
...
BEGIN
	...
	-- Now create any new data that doesn't have an existing id (TODO: is_spot set by is_currency_based_metric)
	...
	SELECT	DISTINCT zone_id, metric_id, attribute_id, date, date_type, val_d, val_i, currency_id, source_id, confidence_id, 0, null, import_id, 11770
	FROM	#import
	WHERE	id IS null
END
